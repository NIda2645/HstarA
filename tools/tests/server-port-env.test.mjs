...
assert.match(main, /def\s+resolve_server_host\([\s\S]*?return\s*["']127\.0\.0\.1["']/, 'development and packaged editions default to loopback unless HSTAR_HOST is explicit');
